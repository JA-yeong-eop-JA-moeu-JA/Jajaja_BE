...
public class SearchController {
    ...
    @Operation(summary = "상품 검색 API | by 구름/윤윤지", description = "키워드 기반으로 상품을 검색하고, 정렬 기준에 따라 결과를 반환합니다.")
    @GetMapping("")
    ...
    @Operation(summary = "인기 검색어 조회 API | by 구름/윤윤지", description = "최근 인기 검색어 8개와 기준 시간을 반환합니다.")
